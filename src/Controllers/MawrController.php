...
namespace edgewizz\mawr\Controllers;
use App\Http\Controllers\Controller;
use Edgewizz\Edgecontent\Models\ProblemSetQues;
use Edgewizz\Mawr\Models\MawrAns;
use Edgewizz\Mawr\Models\MawrQues;
use Illuminate\Http\Request;

class MawrController extends Controller
{
    ...
    public function update($id, Request $request){
        ...
        $q->save();
        $answers = MawrAns::where('question_id', $q->id)->get();
